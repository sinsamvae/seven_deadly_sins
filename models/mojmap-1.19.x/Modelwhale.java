...
public class Modelwhale<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "whale"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-14.0F, -38.0F, -53.0F, 26.0F, 39.0F, 70.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create(),
				PartPose.offset(0.0F, -6.0F, -53.0F));

		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(-1, 228).addBox(-12.0F, -2.5F, -26.0F, 24.0F, 9.0F, 53.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.25F, -0.393F, -24.7321F, 0.3491F, 0.0F, 0.0F));

		PartDefinition cube_r2 = head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 109).addBox(-13.25F, 0.0F, -52.0F, 24.0F, 22.0F, 52.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -30.0F, 0.0F, 0.0436F, 0.0F, 0.0F));

		PartDefinition jaw = head.addOrReplaceChild("jaw", CubeListBuilder.create().texOffs(129, 7).addBox(-5.0F, -5.0F,
				-88.75F, 10.0F, 6.0F, 36.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 6.0F, 53.0F));
		...
		PartDefinition cube_r3 = tail.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(148, 65).addBox(-11.0F, -17.0F, -2.0F, 22.0F, 34.0F, 44.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition tail2 = tail.addOrReplaceChild("tail2", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -15.0F, 61.0F, -0.0873F, 0.0F, 0.0F));

		PartDefinition cube_r4 = tail2.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(108, 148).addBox(-10.0F, -15.0F, 2.0F, 20.0F, 29.0F, 44.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, -6.0F, -0.0873F, 0.0F, 0.0F));

		PartDefinition tailbone = tail2.addOrReplaceChild("tailbone", CubeListBuilder.create().texOffs(185, 0)
				.addBox(-22.0F, 1.0F, -4.0F, 44.0F, 7.0F, 19.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -3.0F, 43.0F));

		PartDefinition fin = partdefinition.addOrReplaceChild("fin",
				CubeListBuilder.create().texOffs(0, 192).addBox(-16.7692F, -2.0F, 0.286F, 17.0F, 6.0F, 28.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = fin2.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 192).addBox(-3.5F, -3.0F, -15.5F, 17.0F, 6.0F, 28.0F,
						new CubeDeformation(0.0F)),
