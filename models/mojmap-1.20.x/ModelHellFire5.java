...
public class ModelHellFire5<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "hellfire5"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(50, 89)
				.addBox(-3.4693F, 5.687F, -1.4034F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.33F)).texOffs(50, 89)
				.addBox(-3.4693F, 5.687F, -0.3834F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.33F)).texOffs(50, 89)
				.addBox(-4.6693F, 5.687F, -1.4034F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.33F)).texOffs(50, 89)
				.addBox(-4.6693F, 5.687F, -0.3834F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.33F)).texOffs(50, 89)
				.addBox(2.5307F, 4.8049F, 0.7145F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.33F)).texOffs(50, 89)
				.addBox(2.5307F, 4.8049F, -0.3055F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.33F)).texOffs(50, 89)
				.addBox(1.3307F, 4.8049F, -0.3055F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.33F)).texOffs(50, 89)
				.addBox(1.3307F, 4.8049F, 0.7145F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.33F)),
				PartPose.offsetAndRotation(-2.0907F, 17.234F, 3.4579F, 1.5708F, 1.5708F, -3.1416F));

		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 24).addBox(-4.3045F, -1.174F, -0.9045F, 5.0F, 2.0F, 2.0F,
						new CubeDeformation(-0.35F)),
				PartPose.offsetAndRotation(19.2713F, -2.5313F, -2.8853F, -0.7333F, -0.639F, 0.493F));

		PartDefinition cube_r2 = bone.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(75, 13).addBox(-0.9682F, -1.174F, -0.931F, 8.0F, 2.0F, 2.0F,
						new CubeDeformation(-0.35F)),
				PartPose.offsetAndRotation(10.9548F, -5.4732F, -7.5031F, -0.6229F, -0.4F, 0.2727F));

		PartDefinition cube_r3 = bone.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 24).addBox(-2.5635F, -1.174F, -0.8565F, 5.0F, 2.0F, 2.0F,
						new CubeDeformation(-0.35F)),
		...
		PartDefinition cube_r4 = bone.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 24).addBox(-4.1435F, -1.174F, -0.9365F, 5.0F, 2.0F, 2.0F,
						new CubeDeformation(-0.35F)),
		...
		PartDefinition cube_r5 = bone.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 24).addBox(-2.7444F, -1.174F, -0.9409F, 5.0F, 2.0F, 2.0F,
						new CubeDeformation(-0.35F)),
		...
		PartDefinition cube_r6 = bone.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(0, 24).addBox(-2.7F, -1.9039F, -1.5147F, 5.0F, 2.0F, 2.0F,
						new CubeDeformation(-0.35F)),
		...
		PartDefinition cube_r7 = bone.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(34, 0).addBox(-9.0F, 0.77F, -5.067F, 12.0F, 0.0F, 12.0F,
		...
		PartDefinition cube_r8 = bone.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(0, 24).addBox(-1.2565F, -1.174F, -0.9365F, 5.0F, 2.0F, 2.0F,
						new CubeDeformation(-0.35F)),
		...
		PartDefinition cube_r9 = bone.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(0, 24).addBox(-2.8365F, -1.174F, -0.8565F, 5.0F, 2.0F, 2.0F,
						new CubeDeformation(-0.35F)),
		...
		PartDefinition cube_r10 = bone.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(75, 13).addBox(-7.4318F, -1.174F, -0.931F, 8.0F, 2.0F, 2.0F,
						new CubeDeformation(-0.35F)),
		...
		PartDefinition cube_r11 = bone.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(0, 24).addBox(-1.0955F, -1.174F, -0.9045F, 5.0F, 2.0F, 2.0F,
						new CubeDeformation(-0.35F)),
		...
		PartDefinition cube_r12 = bone.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(0, 24).addBox(-2.6556F, -1.174F, -0.9409F, 5.0F, 2.0F, 2.0F,
						new CubeDeformation(-0.35F)),
		...
		PartDefinition cube_r13 = bone.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(34, 16).addBox(-3.0F, 0.77F, -5.067F, 6.0F, 0.0F, 12.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r14 = bone.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(37, 29).addBox(-3.0F, 0.77F, -5.067F, 6.0F, 0.0F, 12.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r16 = bone.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(76, 67).addBox(0.7856F, -3.5918F, -4.6419F, 4.0F, 4.0F, 4.0F,
		...
		PartDefinition cube_r17 = bone.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(62, 29).addBox(-0.412F, -4.0414F, -3.1581F, 4.0F, 4.0F, 7.0F,
						new CubeDeformation(-0.6F)),
		...
		PartDefinition cube_r18 = bone.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(62, 42).addBox(-0.412F, -4.0414F, -3.1581F, 4.0F, 4.0F, 7.0F,
						new CubeDeformation(-0.6F)),
		...
		PartDefinition cube_r19 = bone.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(81, 37).addBox(-2.2F, -4.0414F, -1.8895F, 4.0F, 4.0F, 4.0F,
						new CubeDeformation(-0.6F)),
		...
		PartDefinition cube_r20 = bone.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(59, 55).addBox(-3.988F, -4.0414F, -3.1581F, 4.0F, 4.0F, 7.0F,
						new CubeDeformation(-0.6F)),
		...
		PartDefinition cube_r21 = bone.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(62, 42).addBox(-3.988F, -4.0414F, -3.1581F, 4.0F, 4.0F, 7.0F,
						new CubeDeformation(-0.6F)),
				PartPose.offsetAndRotation(0.0907F, -2.1722F, -8.9687F, 0.4215F, -0.3614F, -0.1572F));

		PartDefinition cube_r22 = bone.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(81, 50).addBox(-0.0459F, -2.2744F, -4.0421F, 4.0F, 4.0F, 4.0F,
						new CubeDeformation(-0.6F)),
		...
		PartDefinition cube_r23 = bone.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(15, 82).addBox(-4.3541F, -2.2744F, -4.0421F, 4.0F, 4.0F, 4.0F,
						new CubeDeformation(-0.6F)),
				PartPose.offsetAndRotation(0.0907F, -2.1722F, -8.9687F, -0.0472F, -0.3923F, 0.0181F));

		PartDefinition cube_r24 = bone.addOrReplaceChild("cube_r24",
				CubeListBuilder.create().texOffs(25, 45).addBox(-3.7F, -2.2744F, -2.8463F, 7.0F, 4.0F, 4.0F,
						new CubeDeformation(-0.6F)),
		...
		PartDefinition cube_r25 = bone.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.5F, 0.6634F, 7.2874F, 9.0F, 0.0F, 15.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r26 = bone.addOrReplaceChild("cube_r26",
				CubeListBuilder.create().texOffs(0, 16)
						.addBox(-4.5F, 3.0531F, 2.8121F, 9.0F, 0.0F, 15.0F, new CubeDeformation(0.0F)).texOffs(76, 19)
						.addBox(-1.6F, 1.3167F, 1.8372F, 3.0F, 3.0F, 6.0F, new CubeDeformation(-0.05F)),
		...
		PartDefinition cube_r27 = bone.addOrReplaceChild("cube_r27",
				CubeListBuilder.create().texOffs(28, 55).addBox(-3.0F, -1.884F, -7.3938F, 6.0F, 6.0F, 9.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r28 = bone.addOrReplaceChild("cube_r28",
				CubeListBuilder.create().texOffs(59, 13).addBox(-2.2F, 1.1049F, -17.9977F, 4.0F, 4.0F, 7.0F,
						new CubeDeformation(-0.6F)),
		...
		PartDefinition cube_r29 = bone.addOrReplaceChild("cube_r29",
				CubeListBuilder.create().texOffs(18, 63).addBox(0.9032F, -7.1351F, 2.5732F, 0.0F, 6.0F, 9.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r30 = bone.addOrReplaceChild("cube_r30",
				CubeListBuilder.create().texOffs(66, 70).addBox(-0.8734F, -7.1642F, 2.8197F, 0.0F, 6.0F, 9.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0907F, -5.2611F, 8.573F, -0.0297F, 0.3084F, -1.3634F));

		PartDefinition cube_r31 = bone.addOrReplaceChild("cube_r31",
				CubeListBuilder.create().texOffs(71, 0)
						.addBox(-2.3F, -1.1985F, -1.0603F, 5.0F, 5.0F, 5.0F, new CubeDeformation(-0.15F)).texOffs(0, 58)
						.addBox(-2.4F, 1.8499F, -12.6244F, 5.0F, 5.0F, 8.0F, new CubeDeformation(-0.2F)),
		...
		PartDefinition cube_r32 = bone.addOrReplaceChild("cube_r32",
				CubeListBuilder.create().texOffs(0, 45).addBox(-3.0F, 0.77F, -5.067F, 6.0F, 0.0F, 12.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r33 = bone.addOrReplaceChild("cube_r33",
				CubeListBuilder.create().texOffs(37, 42).addBox(-3.0F, 0.77F, -5.067F, 6.0F, 0.0F, 12.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r34 = bone.addOrReplaceChild("cube_r34",
				CubeListBuilder.create().texOffs(0, 32).addBox(-3.0F, 0.77F, -5.067F, 12.0F, 0.0F, 12.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(13.9546F, -3.5203F, -3.1917F, -0.6037F, 0.3286F, -0.219F));

		PartDefinition cube_r35 = bone.addOrReplaceChild("cube_r35", CubeListBuilder.create().texOffs(50, 89)
				.addBox(-1.16F, -2.1549F, -2.4355F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.33F)).texOffs(50, 89)
				.addBox(0.04F, -2.1549F, -2.4355F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.33F)),
		...
		PartDefinition cube_r36 = bone.addOrReplaceChild("cube_r36",
				CubeListBuilder.create().texOffs(50, 89)
						.addBox(1.84F, -1.16F, -1.35F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.33F)).texOffs(50, 89)
						.addBox(1.84F, -1.16F, -0.33F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.33F)),
		...
		PartDefinition cube_r37 = bone.addOrReplaceChild("cube_r37",
				CubeListBuilder.create().texOffs(50, 89).addBox(-0.82F, -2.32F, -2.68F, 2.0F, 2.0F, 2.0F,
		...
		PartDefinition cube_r38 = bone.addOrReplaceChild("cube_r38",
				CubeListBuilder.create().texOffs(34, 0).addBox(-1.0F, -2.5F, -1.0F, 2.0F, 5.0F, 2.0F,
		...
		PartDefinition cube_r39 = bone.addOrReplaceChild("cube_r39",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-0.9F, -2.4F, -2.6F, 2.0F, 2.0F, 5.0F, new CubeDeformation(-0.2F)).texOffs(0, 0)
						.addBox(-6.9F, -2.4F, -2.6F, 2.0F, 2.0F, 5.0F, new CubeDeformation(-0.2F)),
		...
		PartDefinition cube_r40 = bone.addOrReplaceChild("cube_r40",
				CubeListBuilder.create().texOffs(31, 73)
						.addBox(-1.5F, -3.0F, -3.0F, 3.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(31, 73)
						.addBox(-7.5F, -3.0F, -3.0F, 3.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0907F, -1.8951F, 5.6792F, -0.4363F, 0.0F, 0.0F));

		PartDefinition cube_r41 = bone.addOrReplaceChild("cube_r41", CubeListBuilder.create().texOffs(50, 89)
				.addBox(-1.16F, -2.1549F, -2.4355F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.33F)).texOffs(50, 89)
				.addBox(0.04F, -2.1549F, -2.4355F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.33F)),
		...
		PartDefinition cube_r42 = bone.addOrReplaceChild("cube_r42",
				CubeListBuilder.create().texOffs(50, 89)
						.addBox(-4.16F, -1.16F, -0.33F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.33F)).texOffs(50, 89)
						.addBox(-4.16F, -1.16F, -1.35F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.33F)),
		...
		PartDefinition cube_r43 = bone.addOrReplaceChild("cube_r43",
				CubeListBuilder.create().texOffs(50, 89).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F,
						new CubeDeformation(-0.16F)),
