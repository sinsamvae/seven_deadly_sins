...
public class Modelchastifol_spirit_spear<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "chastifol_spirit_spear"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-1.0F, -6.0F, -1.0F, 1.0F, 8.0F, 1.0F, new CubeDeformation(-0.2F)).texOffs(0, 22)
						.addBox(-1.0F, -6.6F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.17F)).texOffs(18, 21)
						.addBox(-1.0F, -7.22F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.13F)).texOffs(8, 15)
						.addBox(-1.0F, -10.62F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.2F)).texOffs(15, 0)
						.addBox(-1.0F, -11.12F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)).texOffs(13, 20)
						.addBox(-1.0F, -8.67F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.13F)).texOffs(5, 20)
						.addBox(-1.0F, -9.36F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.18F)).texOffs(0, 15)
						.addBox(-1.0F, -9.36F, -1.1F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.19F)).texOffs(12, 13)
						.addBox(-1.0F, -9.36F, -1.1F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.2F)).texOffs(13, 10)
						.addBox(-1.0F, -9.36F, -0.9F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.2F)).texOffs(4, 17)
						.addBox(-1.0F, -10.0F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.15F)).texOffs(21, 10)
						.addBox(-1.0F, -7.91F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.09F)).texOffs(5, 23)
						.addBox(-0.75F, 1.65F, -0.5995F, 0.5F, 0.3F, 0.1989F, new CubeDeformation(0.0F)).texOffs(14, 19)
						.addBox(-0.75F, 2.35F, -0.5995F, 0.5F, 0.3F, 0.1989F, new CubeDeformation(0.0F)).texOffs(10, 7)
						.addBox(-0.75F, 2.0505F, -0.3F, 0.5F, 0.1989F, 0.3F, new CubeDeformation(0.0F)).texOffs(5, 16)
						.addBox(-0.75F, 2.0505F, -1.0F, 0.5F, 0.1989F, 0.3F, new CubeDeformation(0.0F)),
