...
public class ModelBalorMagicalEye<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "balormagicaleye"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head_r2 = Head.addOrReplaceChild("Head_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5225F, -0.4193F, -0.5914F, 1.0F, 1.0F, 1.0F,
		...
		PartDefinition Head_r3 = Head.addOrReplaceChild("Head_r3",
				CubeListBuilder.create().texOffs(0, 3).addBox(-0.3382F, -0.4585F, -0.5522F, 1.0F, 1.0F, 1.0F,
