...
public class Modelflame_ball<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "flame_ball"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cruelsun = partdefinition.addOrReplaceChild("cruelsun",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-11.85F, -16.25F, -12.15F, 24.0F, 26.0F, 24.0F, new CubeDeformation(0.0F))
						.texOffs(0, 51).addBox(-10.5F, -18.0F, -10.5F, 21.0F, 3.0F, 21.0F, new CubeDeformation(0.0F))
						.texOffs(0, 51).addBox(-10.5F, 9.0F, -10.5F, 21.0F, 3.0F, 21.0F, new CubeDeformation(0.0F))
						.texOffs(0, 76).addBox(11.85F, -13.35F, -10.5F, 3.0F, 21.0F, 21.0F, new CubeDeformation(0.0F))
						.texOffs(0, 119).addBox(-10.5F, -13.5F, -15.0F, 21.0F, 21.0F, 3.0F, new CubeDeformation(0.0F))
						.texOffs(0, 119).addBox(-10.5F, -13.5F, 12.0F, 21.0F, 21.0F, 3.0F, new CubeDeformation(0.0F))
						.texOffs(0, 76).addBox(-15.0F, -13.35F, -10.5F, 3.0F, 21.0F, 21.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 16.0F, 0.0F));

		PartDefinition cube_r1 = cruelsun.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(140, 50).addBox(-10.35F, -10.5F, -1.5F, 6.0F, 21.0F, 3.0F,
		...
		PartDefinition cube_r2 = cruelsun.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(140, 50).addBox(4.5F, -10.5F, -1.5F, 6.0F, 21.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-16.864F, -3.0F, -6.5147F, 0.0F, 0.7854F, 0.0F));
		...
		PartDefinition cube_r5 = cruelsun.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(49, 126).addBox(-10.5F, -1.5F, 4.2F, 21.0F, 3.0F, 6.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = cruelsun.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(98, 76).addBox(-3.0F, -1.5F, -10.5F, 6.0F, 3.0F, 21.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = cruelsun.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(49, 126).addBox(-10.5F, -1.5F, -3.15F, 21.0F, 3.0F, 6.0F,
						new CubeDeformation(0.0F)),
