...
public class Modelking_wings<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "king_wings"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition wing1 = partdefinition
				.addOrReplaceChild("wing1",
						CubeListBuilder.create().texOffs(0, 14).addBox(0.0F, -6.0F, -1.0F, 7.0F, 12.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 6.0F, 2.0F, 0.0F, -0.7854F, 0.0F));

		PartDefinition Body_r1 = wing1.addOrReplaceChild("Body_r1",
