...
public class Modelhelbramwings<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "helbramwings"), "main");
	private final ModelPart helbramwing;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition helbramwing = partdefinition.addOrReplaceChild("helbramwing", CubeListBuilder.create(),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition Body_r1 = helbramwing.addOrReplaceChild("Body_r1",
		...
		PartDefinition Body_r2 = helbramwing.addOrReplaceChild("Body_r2",
		...
		PartDefinition Body_r3 = helbramwing.addOrReplaceChild("Body_r3",
		...
		PartDefinition Body_r4 = helbramwing.addOrReplaceChild("Body_r4",
		...
		PartDefinition Body_r5 = helbramwing.addOrReplaceChild("Body_r5",
		...
		PartDefinition Body_r6 = helbramwing.addOrReplaceChild("Body_r6",
		...
		PartDefinition Body_r7 = helbramwing.addOrReplaceChild("Body_r7",
				CubeListBuilder.create().texOffs(34, 30).addBox(-3.0F, -2.0F, 0.0F, 8.0F, 4.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.3124F, -3.1532F, 4.1106F, 0.0873F, 0.1309F, 0.0F));

		PartDefinition Body_r8 = helbramwing.addOrReplaceChild("Body_r8",
