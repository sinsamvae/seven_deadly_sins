...
public class NoroiNoKoeWhileProjectileFlyingTickProcedure {
			...
			CraftNoTaizaiMod.queueServerWork((int) delay, () -> {
				...
				CraftNoTaizaiMod.queueServerWork(30, () -> {
					if (world instanceof ServerLevel _level)
						_level.sendParticles(ParticleTypes.SONIC_BOOM, (entity.getPersistentData().getDouble("sx")), (entity.getPersistentData().getDouble("sy")), (entity.getPersistentData().getDouble("sz")), 4, 0.02, 0.02, 0.02, 0);
