...
public class SetFairyGloxinaMagicProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		double RandomMagic = 0;
		if (CraftNoTaizaiModVariables.MapVariables.get(world).gloxina_fairyking == true && CraftNoTaizaiModVariables.MapVariables.get(world).fairyking == false) {
