...
public class IncreaseTrueSpirtSpearDamageProcedure {
			...
			if (!projectileLevel.isClientSide()) {
				Projectile _entityToSpawn = new Object() {
					public Projectile getArrow(Level level, Entity shooter, float damage, int knockback, byte piercing) {
						AbstractArrow entityToSpawn = new IncreaseTrueSpiritSpearProjectileEntity(CraftNoTaizaiModEntities.INCREASE_TRUE_SPIRIT_SPEAR_PROJECTILE.get(), level);
				...
				}.getArrow(projectileLevel, entity, (float) damage, 1, (byte) 3);
