...
public class DivineCutsProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if ((((entity.getCapability(CraftNoTaizaiModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CraftNoTaizaiModVariables.PlayerVariables())).AbilitySelect).getOrCreateTag()
				.getString(("skill" + (entity.getCapability(CraftNoTaizaiModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CraftNoTaizaiModVariables.PlayerVariables())).Move))).equals("1000 Divine Cuts")) {
			if (((entity.getCapability(CraftNoTaizaiModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CraftNoTaizaiModVariables.PlayerVariables())).AbilitySelect).getOrCreateTag()
					...
					if ((entity.getCapability(CraftNoTaizaiModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CraftNoTaizaiModVariables.PlayerVariables())).mana >= 80
						...
						if (entity.isShiftKeyDown()) {
								...
								for (Entity entityiterator : _entfound) {
									if (!(entity == entityiterator)) {
										...
										if (world instanceof ServerLevel _level)
											_level.sendParticles((SimpleParticleType) (CraftNoTaizaiModParticleTypes.DIVINE_CUTS_PARTICLES.get()), (entityiterator.getX()), (entityiterator.getY()), (entityiterator.getZ()), 10, 0.1, 3, 0.1, 0.1);
									}
								}
							}
						} else {
							{
								...
								for (Entity entityiterator : _entfound) {
									if (!(entity == entityiterator)) {
										entity.setDeltaMovement(new Vec3((5.5 * entity.getLookAngle().x), (0 * entity.getLookAngle().y), (5.5 * entity.getLookAngle().z)));
										if (world instanceof ServerLevel _level)
											_level.sendParticles((SimpleParticleType) (CraftNoTaizaiModParticleTypes.DIVINE_CUTS_PARTICLES.get()), (entityiterator.getX()), (entityiterator.getY()), (entityiterator.getZ()), 10, 0.1, 3, 0.1, 0);
										if (world instanceof Level _level) {
											if (!_level.isClientSide()) {
												_level.playSound(null, BlockPos.containing(entityiterator.getX(), entityiterator.getY(), entityiterator.getZ()),
														ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.player.attack.sweep")), SoundSource.NEUTRAL, 1, 1);
										...
										entityiterator
												.hurt(new DamageSource(world.registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation("craft_no_taizai:delay_damage"))),
														entity), (float) (Math.ceil(0.45 * (entity.getCapability(CraftNoTaizaiModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CraftNoTaizaiModVariables.PlayerVariables())).ManaAttack) + 1));
									}
								}
							}
						}
