...
public class GilthunderDieNearHendricksonProcedure {
	@SubscribeEvent
		...
		if (entity instanceof GilThunderAnimated2Entity) {
			{
				...
				for (Entity entityiterator : _entfound) {
					if (entityiterator instanceof HendricksonAnimatedEntity) {
						entityiterator.getPersistentData().putBoolean("GilThunderDeath", true);
						if (entityiterator instanceof Mob _entity && ((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, z), 100, 100, 100), e -> true).stream().sorted(new Object() {
