			...
			CraftNoTaizaiMod.queueServerWork((int) rep, () -> {
				...
				for (int index1 = 0; index1 < 60; index1++) {
					...
					for (int index2 = 0; index2 < 3; index2++) {
						...
						RisingTornadoDamageProcedure.execute(world, entity.getPersistentData().getDouble("pX") + Math.sin(entity.getPersistentData().getDouble("rep")) * entity.getPersistentData().getDouble("distance"),
								entity.getPersistentData().getDouble("pY") + entity.getPersistentData().getDouble("height"),
								entity.getPersistentData().getDouble("pZ") + Math.cos(entity.getPersistentData().getDouble("rep")) * entity.getPersistentData().getDouble("distance"), entity);
