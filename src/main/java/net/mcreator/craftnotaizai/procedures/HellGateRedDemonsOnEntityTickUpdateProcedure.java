...
public class HellGateRedDemonsOnEntityTickUpdateProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (!((entity instanceof TamableAnimal _tamEnt ? (Entity) _tamEnt.getOwner() : null) == null)) {
			entity.getPersistentData().putDouble("attack", (Math.ceil(
					...
					+ 1));
			entity.getPersistentData().putDouble("magic",
				...
				CraftNoTaizaiMod.queueServerWork(8, () -> {
					{
						...
						if (!projectileLevel.isClientSide()) {
							...
							}.getArrow(projectileLevel, entity, (float) (Math.ceil(0.45 * entity.getPersistentData().getDouble("magic")) + 1), 1);
