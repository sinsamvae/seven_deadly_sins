...
public class BasquiasProjectileWhileProjectileFlyingTickProcedure {
		...
		for (int index0 = 0; index0 < (int) (entity.getPersistentData().getDouble("range") * 5); index0++) {
			...
			CraftNoTaizaiMod.queueServerWork((int) delay, () -> {
				...
				if (world instanceof ServerLevel _level)
					_level.sendParticles((SimpleParticleType) (CraftNoTaizaiModParticleTypes.HUNTER_WISPPARTICLE.get()), x, y, z, 10, 0.3, 0.3, 0.3, 0.1);
