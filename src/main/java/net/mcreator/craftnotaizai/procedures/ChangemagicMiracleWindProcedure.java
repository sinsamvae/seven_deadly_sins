...
public class ChangemagicMiracleWindProcedure {
	public static void execute(CommandContext<CommandSourceStack> arguments) {
		...
		}.getEntity()).getPersistentData().putString("Ability1", "Manpuu no Gekirin");
		(new Object() {
			public Entity getEntity() {
				try {
					return EntityArgument.getEntity(arguments, "Player");
		...
		}.getEntity()).getPersistentData().putString("Ability2", "Soyokaze no Gekirin");
		(new Object() {
			public Entity getEntity() {
				try {
					return EntityArgument.getEntity(arguments, "Player");
		...
		}.getEntity()).getPersistentData().putString("Ability3", "Tempest Falls");
		(new Object() {
			public Entity getEntity() {
				try {
					return EntityArgument.getEntity(arguments, "Player");
