...
public class CloneSkill2Procedure {
				...
				for (Entity entityiterator : _entfound) {
					if (!(entityiterator == entity || entityiterator instanceof ItemEntity || entityiterator instanceof ExperienceOrb
						...
						CraftNoTaizaiMod.queueServerWork(20, () -> {
							entityiterator.hurt(new DamageSource(world.registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypes.PLAYER_ATTACK)), (float) entity.getPersistentData().getDouble("ManaDmg"));
							if (world instanceof ServerLevel _level)
