	...
	public static void execute(LevelAccessor world, Entity entity) {
		...
		for (int index0 = 0; index0 < 10; index0++) {
			world.addParticle(ParticleTypes.SPIT,
					...
					(entity.level().clip(new ClipContext(entity.getEyePosition(1f), entity.getEyePosition(1f).add(entity.getViewVector(1f).scale(range)), ClipContext.Block.OUTLINE, ClipContext.Fluid.NONE, entity)).getBlockPos().getZ()), 0.2, 0.2,
					0.2);
