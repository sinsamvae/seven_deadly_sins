...
public class BusterIceWhileProjectileFlyingTickProcedure {
		...
		for (int index0 = 0; index0 < (int) (entity.getPersistentData().getDouble("range") * 5); index0++) {
			...
			CraftNoTaizaiMod.queueServerWork((int) delay, () -> {
				...
				if (world instanceof ServerLevel _level)
					_level.sendParticles((SimpleParticleType) (CraftNoTaizaiModParticleTypes.FREEZE_COFFIN.get()), x, y, z, 5, 0.3, 0.3, 0.3, 0.1);
