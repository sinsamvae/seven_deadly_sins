...
public class ChangemagicBreakProcedure {
	public static void execute(CommandContext<CommandSourceStack> arguments) {
		...
		}.getEntity()).getPersistentData().putString("Ability1", "Rakan");
		(new Object() {
			public Entity getEntity() {
				try {
					return EntityArgument.getEntity(arguments, "Player");
		...
		}.getEntity()).getPersistentData().putString("Ability2", "H\u014Dgeki");
		(new Object() {
			public Entity getEntity() {
				try {
					return EntityArgument.getEntity(arguments, "Player");
		...
		}.getEntity()).getPersistentData().putString("Ability3", "Kantotsu");
		(new Object() {
			public Entity getEntity() {
				try {
					return EntityArgument.getEntity(arguments, "Player");
