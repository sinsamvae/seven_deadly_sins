		...
		if ((entity.getCapability(CraftNoTaizaiModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CraftNoTaizaiModVariables.PlayerVariables())).GravityTen == true) {
			...
			if (target && entity_target instanceof LivingEntity) {
				if (world instanceof ServerLevel _level)
					_level.sendParticles((SimpleParticleType) (CraftNoTaizaiModParticleTypes.GRAVITY_PARTICLES.get()), (entity_target.getX()), (entity_target.getY() + 1), (entity_target.getZ()), 30, 4, 3, 4, 0);
				{
