				...
				for (Entity entityiterator : _entfound) {
					if (!(target || entityiterator == entity || entityiterator instanceof ItemEntity || entityiterator instanceof ExperienceOrb
						...
						if (world instanceof ServerLevel _level)
							_level.sendParticles((SimpleParticleType) (CraftNoTaizaiModParticleTypes.GRAVITY_PARTICLES.get()), (entityiterator.getX()), (entityiterator.getY() + 1), (entityiterator.getZ()), 30, 4, 3, 4, 0);
						{
