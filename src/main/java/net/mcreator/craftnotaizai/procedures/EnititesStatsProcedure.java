...
public class EnititesStatsProcedure {
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		if (!entity.getType().is(TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation("craft_no_taizai:tamed_skills")))) {
			...
			entity.getPersistentData().putDouble("strength", (entity instanceof LivingEntity _attributeContext ? _attributeContext.getAttributeValue(net.minecraft.world.entity.ai.attributes.Attributes.ATTACK_DAMAGE) : 0.0D));
