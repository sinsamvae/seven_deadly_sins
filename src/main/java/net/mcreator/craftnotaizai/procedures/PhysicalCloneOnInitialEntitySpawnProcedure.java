		...
		if (entity instanceof PhysicalCloneEntity && !(entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false)) {
			{
				...
				for (Entity entityiterator : _entfound) {
					if (entityiterator instanceof Player && (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == CraftNoTaizaiModItems.LOSTVAYNE.get()) {
