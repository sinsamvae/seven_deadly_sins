...
public class ChangeMagicGravityProcedure {
	public static void execute(CommandContext<CommandSourceStack> arguments) {
		...
		}.getEntity()).getPersistentData().putString("Ability1", "Gravity Ten");
		(new Object() {
			public Entity getEntity() {
				try {
					return EntityArgument.getEntity(arguments, "Player");
		...
		}.getEntity()).getPersistentData().putString("Ability2", "Hyper Gravity");
		(new Object() {
			public Entity getEntity() {
				try {
					return EntityArgument.getEntity(arguments, "Player");
