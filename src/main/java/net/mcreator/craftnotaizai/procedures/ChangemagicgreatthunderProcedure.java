...
public class ChangemagicgreatthunderProcedure {
	public static void execute(CommandContext<CommandSourceStack> arguments) {
		...
		}.getEntity()).getPersistentData().putString("Ability1", "Raijin no Shukusei");
		(new Object() {
			public Entity getEntity() {
				try {
					return EntityArgument.getEntity(arguments, "Player");
		...
		}.getEntity()).getPersistentData().putString("Ability2", "Raijinken");
		(new Object() {
			public Entity getEntity() {
				try {
					return EntityArgument.getEntity(arguments, "Player");
