...
import net.mcreator.craftnotaizai.procedures.CreateGuildProcedureProcedure;
...
public class CreateGuildCommand {
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("Create_Guild")
				...
				.then(Commands.argument("Player", EntityArgument.players()).then(Commands.argument("name", StringArgumentType.word()).executes(arguments -> {
					...
					CreateGuildProcedureProcedure.execute(arguments, entity);
					return 0;
				}))));
	}
}
