...
public abstract class MeliodasBoarHatItem extends ArmorItem {
	public MeliodasBoarHatItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends MeliodasBoarHatItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/meliodas_season_2_outfit.png";
		}
	}

	public static class Leggings extends MeliodasBoarHatItem {
		public Leggings() {
