...
public abstract class EscanorArmorItem extends ArmorItem {
	public EscanorArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends EscanorArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/escanor_armor.png";
		}
	}

	public static class Chestplate extends EscanorArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends EscanorArmorItem {
		public Leggings() {
