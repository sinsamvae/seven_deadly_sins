...
public abstract class KingsArmorItem extends ArmorItem {
	public KingsArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends KingsArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/king_armor.png";
		}
	}

	public static class Chestplate extends KingsArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends KingsArmorItem {
		public Leggings() {
