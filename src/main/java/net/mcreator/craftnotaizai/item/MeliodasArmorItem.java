...
public abstract class MeliodasArmorItem extends ArmorItem {
	public MeliodasArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends MeliodasArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/meliodas-armor.png";
		}
	}

	public static class Chestplate extends MeliodasArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends MeliodasArmorItem {
		public Leggings() {
