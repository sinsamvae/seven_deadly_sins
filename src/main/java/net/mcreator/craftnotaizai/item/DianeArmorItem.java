...
public abstract class DianeArmorItem extends ArmorItem {
	public DianeArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends DianeArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/diane_armor.png";
		}
	}

	public static class Chestplate extends DianeArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends DianeArmorItem {
		public Leggings() {
