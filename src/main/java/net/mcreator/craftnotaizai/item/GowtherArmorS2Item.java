...
public abstract class GowtherArmorS2Item extends ArmorItem {
	public GowtherArmorS2Item(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(Blocks.WHITE_WOOL), new ItemStack(Blocks.BLUE_WOOL), new ItemStack(Blocks.PURPLE_WOOL));
			}

			@Override
			public String getName() {
				return "gowther_armor_s_2";
			}
	...
	public static class Chestplate extends GowtherArmorS2Item {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/gowther_s2_armor.png";
		}
	}

	public static class Leggings extends GowtherArmorS2Item {
		public Leggings() {
