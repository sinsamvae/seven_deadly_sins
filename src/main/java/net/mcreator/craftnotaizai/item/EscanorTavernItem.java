...
public abstract class EscanorTavernItem extends ArmorItem {
	public EscanorTavernItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public int getDefenseForType(ArmorItem.Type type) {
				return new int[]{2, 5, 10, 1}[type.getSlot().getIndex()];
			}
	...
	public static class Helmet extends EscanorTavernItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/escanor_outfit.png";
		}
	}

	public static class Chestplate extends EscanorTavernItem {
		public Chestplate() {
	...
	public static class Leggings extends EscanorTavernItem {
		public Leggings() {
