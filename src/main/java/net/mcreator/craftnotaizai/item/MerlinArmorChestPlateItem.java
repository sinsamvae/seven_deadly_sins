...
public abstract class MerlinArmorChestPlateItem extends ArmorItem {
	public MerlinArmorChestPlateItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public int getDefenseForType(ArmorItem.Type type) {
				return new int[]{2, 7, 10, 6}[type.getSlot().getIndex()];
			}
			...
			public String getName() {
				return "merlin_armor_chest_plate";
			}
	...
	public static class Helmet extends MerlinArmorChestPlateItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/merlin_armor.png";
		}
	}

	public static class Chestplate extends MerlinArmorChestPlateItem {
		public Chestplate() {
	...
	public static class Leggings extends MerlinArmorChestPlateItem {
		public Leggings() {
