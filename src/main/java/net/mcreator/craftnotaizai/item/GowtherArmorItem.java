...
public abstract class GowtherArmorItem extends ArmorItem {
	public GowtherArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends GowtherArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/gowther_armor.png";
		}
	}

	public static class Chestplate extends GowtherArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends GowtherArmorItem {
		public Leggings() {
