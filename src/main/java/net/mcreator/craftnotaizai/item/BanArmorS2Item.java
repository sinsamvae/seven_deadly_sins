...
public abstract class BanArmorS2Item extends ArmorItem {
	public BanArmorS2Item(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(Blocks.RED_WOOL), new ItemStack(Blocks.PINK_WOOL));
			}

			@Override
			public String getName() {
				return "ban_armor_s_2";
			}
	...
	public static class Helmet extends BanArmorS2Item {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/ban_season_2.png";
		}
	}

	public static class Chestplate extends BanArmorS2Item {
		public Chestplate() {
	...
	public static class Leggings extends BanArmorS2Item {
		public Leggings() {
