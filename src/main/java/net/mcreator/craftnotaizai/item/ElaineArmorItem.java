...
public abstract class ElaineArmorItem extends ArmorItem {
	public ElaineArmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(Blocks.WHITE_WOOL), new ItemStack(Blocks.PINK_WOOL));
			}
	...
	public static class Chestplate extends ElaineArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/elaine_armor.png";
		}
	}

	public static class Leggings extends ElaineArmorItem {
		public Leggings() {
