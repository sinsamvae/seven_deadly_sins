...
public class RhittaBlockTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public RhittaBlockTileEntity(BlockPos pos, BlockState state) {
		super(CraftNoTaizaiModBlockEntities.RHITTA_BLOCK.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(RhittaBlockBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<RhittaBlockTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<RhittaBlockTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("rhitta_block");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Rhitta Block");
	}
