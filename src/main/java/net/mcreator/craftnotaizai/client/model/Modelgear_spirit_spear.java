...
public class Modelgear_spirit_spear<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("craft_no_taizai", "modelgear_spirit_spear"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5006F, 1.1458F, -0.5179F, 1.0F, 8.0F, 1.0F, new CubeDeformation(-0.2F)).texOffs(0, 22).addBox(-0.5006F, 0.5458F, -0.5179F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.17F)).texOffs(18, 21)
						.addBox(-0.5006F, -0.0742F, -0.5179F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.13F)).texOffs(8, 15).addBox(-0.5006F, -3.4742F, -0.5179F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.2F)).texOffs(15, 0)
						.addBox(-0.5006F, -3.9742F, -0.5179F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)).texOffs(13, 20).addBox(-0.5006F, -1.5242F, -0.5179F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.13F)).texOffs(5, 20)
						.addBox(-0.5006F, -2.2142F, -0.5179F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.18F)).texOffs(0, 15).addBox(-0.5006F, -2.2142F, -0.6179F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.19F)).texOffs(12, 13)
						.addBox(-0.5006F, -2.2142F, -0.6179F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.2F)).texOffs(13, 10).addBox(-0.5006F, -2.2142F, -0.4179F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.2F)).texOffs(4, 17)
						.addBox(-0.5006F, -2.8542F, -0.5179F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.15F)).texOffs(21, 10).addBox(-0.5006F, -0.7642F, -0.5179F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.09F)).texOffs(5, 23)
						.addBox(-0.2506F, 8.7958F, -0.1174F, 0.5F, 0.3F, 0.1989F, new CubeDeformation(0.0F)).texOffs(14, 19).addBox(-0.2506F, 9.4958F, -0.1174F, 0.5F, 0.3F, 0.1989F, new CubeDeformation(0.0F)).texOffs(10, 7)
						.addBox(-0.2506F, 9.1963F, 0.1821F, 0.5F, 0.1989F, 0.3F, new CubeDeformation(0.0F)).texOffs(5, 16).addBox(-0.2506F, 9.1963F, -0.5179F, 0.5F, 0.1989F, 0.3F, new CubeDeformation(0.0F)),
