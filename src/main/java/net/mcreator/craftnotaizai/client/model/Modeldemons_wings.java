...
public class Modeldemons_wings<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("craft_no_taizai", "modeldemons_wings"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leftwing = partdefinition.addOrReplaceChild("leftwing", CubeListBuilder.create(), PartPose.offset(4.0F, 0.1132F, 6.0604F));
		...
		PartDefinition Body_r16 = leftwing.addOrReplaceChild("Body_r16", CubeListBuilder.create().texOffs(22, 21).addBox(-0.5F, 2.5008F, -1.4147F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.05F)),
				PartPose.offsetAndRotation(1.0F, 1.0F, 0.0F, -0.8133F, 0.75F, -0.1486F));
		PartDefinition rightwing = partdefinition.addOrReplaceChild("rightwing", CubeListBuilder.create(), PartPose.offset(-4.0F, 0.1132F, 6.0604F));
