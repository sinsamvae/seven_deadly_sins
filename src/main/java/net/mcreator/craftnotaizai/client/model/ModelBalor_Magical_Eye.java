...
public class ModelBalor_Magical_Eye<T extends Entity> extends EntityModel<T> {
	...
	public ModelBalor_Magical_Eye(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head_r1 = Head.addOrReplaceChild("Head_r1", CubeListBuilder.create().texOffs(5, 3).addBox(0.0F, -0.255F, -0.745F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.9885F, -3.7223F, -1.1143F, 0.6981F, 1.2217F, -0.3491F));
		PartDefinition Head_r2 = Head.addOrReplaceChild("Head_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5225F, -0.4193F, -0.5914F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.32F)).texOffs(0, 3).addBox(-0.3382F, -0.4585F, -0.5522F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F)),
				PartPose.offsetAndRotation(4.1726F, -2.372F, -1.2489F, 2.3527F, 0.1706F, -0.1144F));
		PartDefinition Head_r3 = Head.addOrReplaceChild("Head_r3", CubeListBuilder.create().texOffs(5, 0).addBox(-0.0362F, -0.2344F, -0.7482F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.3216F, -2.372F, -1.4989F, 2.3527F, 0.1706F, -0.1144F));
