...
public class Modelkillericebergb2<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("craft_no_taizai", "modelkillericebergb_2"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone7 = partdefinition.addOrReplaceChild("bone7", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, 0.0F, -1.5708F, 1.5708F));
		PartDefinition bone5 = bone7.addOrReplaceChild("bone5",
				CubeListBuilder.create().texOffs(-10, -5).addBox(-2.0F, -2.0F, -8.45F, 4.0F, 4.0F, 17.0F, new CubeDeformation(0.0F)).texOffs(5, 10).addBox(-1.75F, -1.75F, -9.45F, 3.5F, 3.5F, 2.0F, new CubeDeformation(0.0F)).texOffs(6, 9)
						.addBox(-1.5F, -1.5F, -10.45F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(6, 10).addBox(-1.5F, -1.5F, 8.3F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 1)
