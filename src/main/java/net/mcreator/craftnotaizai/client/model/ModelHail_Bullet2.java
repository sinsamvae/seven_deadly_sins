...
public class ModelHail_Bullet2<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("craft_no_taizai", "model_hail_bullet_2"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone6 = partdefinition.addOrReplaceChild("bone6", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, 0.0F, -1.5708F, 1.5708F));
		PartDefinition bone2 = bone6.addOrReplaceChild("bone2",
				CubeListBuilder.create().texOffs(11, 17).addBox(-2.0F, -2.0F, -1.85F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(10, 8).addBox(-1.75F, -1.75F, -2.6F, 3.5F, 3.5F, 4.0F, new CubeDeformation(0.0F)).texOffs(10, 18)
						.addBox(-1.5F, -1.5F, -3.1F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 20).addBox(-1.5F, -1.5F, -1.1F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(12, 17)
