...
public class DemonClanScreen extends AbstractContainerScreen<DemonClanMenu> {
	...
	public void init() {
		...
		imagebutton_overarrow = new ImageButton(this.leftPos + -140, this.topPos + -14, 16, 16, 0, 0, 16, new ResourceLocation("craft_no_taizai:textures/screens/atlas/imagebutton_overarrow.png"), 16, 32, e -> {
			if (true) {
				CraftNoTaizaiMod.PACKET_HANDLER.sendToServer(new DemonClanButtonMessage(0, x, y, z, textstate));
				DemonClanButtonMessage.handleButtonAction(entity, 0, x, y, z, textstate);
			}
		});
		...
		imagebutton_overarrow2 = new ImageButton(this.leftPos + 102, this.topPos + -14, 16, 16, 0, 0, 16, new ResourceLocation("craft_no_taizai:textures/screens/atlas/imagebutton_overarrow2.png"), 16, 32, e -> {
			if (true) {
				CraftNoTaizaiMod.PACKET_HANDLER.sendToServer(new DemonClanButtonMessage(1, x, y, z, textstate));
				DemonClanButtonMessage.handleButtonAction(entity, 1, x, y, z, textstate);
			}
		});
		...
		imagebutton_select = new ImageButton(this.leftPos + -48, this.topPos + 91, 64, 16, 0, 0, 16, new ResourceLocation("craft_no_taizai:textures/screens/atlas/imagebutton_select.png"), 64, 32, e -> {
			if (true) {
				CraftNoTaizaiMod.PACKET_HANDLER.sendToServer(new DemonClanButtonMessage(2, x, y, z, textstate));
				DemonClanButtonMessage.handleButtonAction(entity, 2, x, y, z, textstate);
			}
		});
