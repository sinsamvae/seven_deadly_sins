...
public class FairyClanScreen extends AbstractContainerScreen<FairyClanMenu> {
	...
	public void init() {
		...
		imagebutton_overarrow = new ImageButton(this.leftPos + -138, this.topPos + -14, 16, 16, 0, 0, 16, new ResourceLocation("craft_no_taizai:textures/screens/atlas/imagebutton_overarrow.png"), 16, 32, e -> {
			if (true) {
				CraftNoTaizaiMod.PACKET_HANDLER.sendToServer(new FairyClanButtonMessage(0, x, y, z, textstate));
				FairyClanButtonMessage.handleButtonAction(entity, 0, x, y, z, textstate);
			}
		});
		...
		imagebutton_overarrow2 = new ImageButton(this.leftPos + 102, this.topPos + -14, 16, 16, 0, 0, 16, new ResourceLocation("craft_no_taizai:textures/screens/atlas/imagebutton_overarrow2.png"), 16, 32, e -> {
			if (true) {
				CraftNoTaizaiMod.PACKET_HANDLER.sendToServer(new FairyClanButtonMessage(1, x, y, z, textstate));
				FairyClanButtonMessage.handleButtonAction(entity, 1, x, y, z, textstate);
			}
		});
		...
		imagebutton_select = new ImageButton(this.leftPos + -48, this.topPos + 91, 64, 16, 0, 0, 16, new ResourceLocation("craft_no_taizai:textures/screens/atlas/imagebutton_select.png"), 64, 32, e -> {
			if (true) {
				CraftNoTaizaiMod.PACKET_HANDLER.sendToServer(new FairyClanButtonMessage(2, x, y, z, textstate));
				FairyClanButtonMessage.handleButtonAction(entity, 2, x, y, z, textstate);
			}
		});
