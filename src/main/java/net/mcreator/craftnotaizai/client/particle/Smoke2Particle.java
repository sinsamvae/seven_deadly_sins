...
public class Smoke2Particle extends TextureSheetParticle {
	public static Smoke2ParticleProvider provider(SpriteSet spriteSet) {
		return new Smoke2ParticleProvider(spriteSet);
	}
	...
	public static class Smoke2ParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			Smoke2Particle particle = new Smoke2Particle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
			return particle;
		}
	}
