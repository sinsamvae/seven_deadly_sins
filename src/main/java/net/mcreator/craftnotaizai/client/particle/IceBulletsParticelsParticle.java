...
@OnlyIn(Dist.CLIENT)
public class IceBulletsParticelsParticle extends TextureSheetParticle {
	public static IceBulletsParticelsParticleProvider provider(SpriteSet spriteSet) {
		return new IceBulletsParticelsParticleProvider(spriteSet);
	}

	public static class IceBulletsParticelsParticleProvider implements ParticleProvider<SimpleParticleType> {
		private final SpriteSet spriteSet;

		public IceBulletsParticelsParticleProvider(SpriteSet spriteSet) {
			this.spriteSet = spriteSet;
		}

		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			IceBulletsParticelsParticle particle = new IceBulletsParticelsParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
			class IceBulletsParticelsRenderSequence {
				...
				public void render(RenderLevelStageEvent event) {
					if (event.getStage() == RenderLevelStageEvent.Stage.AFTER_PARTICLES) {
						VertexConsumer consumer = Minecraft.getInstance().renderBuffers().bufferSource().getBuffer(RenderType.entityTranslucent(new ResourceLocation("craft_no_taizai:textures/particle/ice_bullets_particels.png")));
			...
			IceBulletsParticelsRenderSequence sequence = new IceBulletsParticelsRenderSequence();
	...
	protected IceBulletsParticelsParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
		super(world, x, y, z);
		this.spriteSet = spriteSet;
