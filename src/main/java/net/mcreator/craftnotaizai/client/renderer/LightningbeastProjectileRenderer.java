...
public class LightningbeastProjectileRenderer extends EntityRenderer<LightningbeastProjectileEntity> {
	...
	@Override
	public void render(LightningbeastProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(LightningbeastProjectileEntity entity) {
		return texture;
	}
}
