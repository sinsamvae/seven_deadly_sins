...
public class BlazeProjectileRenderer extends EntityRenderer<BlazeProjectileEntity> {
	...
	@Override
	public void render(BlazeProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(BlazeProjectileEntity entity) {
		return texture;
	}
}
