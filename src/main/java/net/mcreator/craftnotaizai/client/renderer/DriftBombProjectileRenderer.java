...
public class DriftBombProjectileRenderer extends EntityRenderer<DriftBombProjectileEntity> {
	...
	public DriftBombProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new ModelDrift_Bomb(context.bakeLayer(ModelDrift_Bomb.LAYER_LOCATION));
	}

	@Override
	public void render(DriftBombProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(DriftBombProjectileEntity entity) {
		return texture;
	}
}
