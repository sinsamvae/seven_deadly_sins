...
public class PhysicalCloneRenderer extends HumanoidMobRenderer<PhysicalCloneEntity, HumanoidModel<PhysicalCloneEntity>> {
	...
	private final HumanoidModel<PhysicalCloneEntity> slimModel;
	private final HumanoidModel<PhysicalCloneEntity> defaultModel;
	...
	public ResourceLocation getTextureLocation(PhysicalCloneEntity entity) {
		if (entity.isTame() && entity.getOwnerUUID() != null) {
			...
			return new ResourceLocation("craft_no_taizai:textures/entities/blank.png");
		}
	}

	@Override
	public void render(PhysicalCloneEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
		if (entity.isTame() && entity.getOwnerUUID() != null) {
			UUID ownerUUID = entity.getOwnerUUID();
	...
	private HumanoidModel<PhysicalCloneEntity> getModel(UUID uuid) {
