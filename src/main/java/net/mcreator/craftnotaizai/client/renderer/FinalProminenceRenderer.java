...
public class FinalProminenceRenderer extends EntityRenderer<FinalProminenceEntity> {
	...
	public FinalProminenceRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new ModelCruel_Sun_Converted(context.bakeLayer(ModelCruel_Sun_Converted.LAYER_LOCATION));
	}

	@Override
	public void render(FinalProminenceEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(FinalProminenceEntity entity) {
		return texture;
	}
}
