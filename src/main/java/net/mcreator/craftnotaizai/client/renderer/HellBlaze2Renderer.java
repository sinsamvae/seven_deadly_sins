...
public class HellBlaze2Renderer extends EntityRenderer<HellBlaze2Entity> {
	...
	@Override
	public void render(HellBlaze2Entity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(HellBlaze2Entity entity) {
		return texture;
	}
}
