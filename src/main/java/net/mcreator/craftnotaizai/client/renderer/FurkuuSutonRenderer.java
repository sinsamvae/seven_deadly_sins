...
public class FurkuuSutonRenderer extends EntityRenderer<FurkuuSutonEntity> {
	...
	@Override
	public void render(FurkuuSutonEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(FurkuuSutonEntity entity) {
		return texture;
	}
}
