...
public class HellBlaze2Entity extends AbstractArrow implements ItemSupplier {
	...
	public HellBlaze2Entity(EntityType<? extends HellBlaze2Entity> type, Level world) {
		super(type, world);
	}

	public HellBlaze2Entity(EntityType<? extends HellBlaze2Entity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public HellBlaze2Entity(EntityType<? extends HellBlaze2Entity> type, LivingEntity entity, Level world) {
	...
	public static HellBlaze2Entity shoot(Level world, LivingEntity entity, RandomSource source) {
		return shoot(world, entity, source, 1f, 5, 5);
	}

	public static HellBlaze2Entity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
		return shoot(world, entity, source, pullingPower * 1f, 5, 5);
	}

	public static HellBlaze2Entity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		HellBlaze2Entity entityarrow = new HellBlaze2Entity(CraftNoTaizaiModEntities.HELL_BLAZE_2.get(), entity, world);
	...
	public static HellBlaze2Entity shoot(LivingEntity entity, LivingEntity target) {
		HellBlaze2Entity entityarrow = new HellBlaze2Entity(CraftNoTaizaiModEntities.HELL_BLAZE_2.get(), entity, entity.level());
