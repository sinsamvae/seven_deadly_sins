...
import net.mcreator.craftnotaizai.procedures.AuraBurstProjectileHitsLivingEntityProcedure;
...
public class AuraBurstEntity extends AbstractArrow implements ItemSupplier {
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		AuraBurstProjectileHitsLivingEntityProcedure.execute(this.level(), entityHitResult.getEntity(), this);
	}
