...
import net.mcreator.craftnotaizai.procedures.DianeSpawnBossProcedure;
...
public class DianeBossAnimatedEntity extends PathfinderMob implements GeoEntity {
	...
	public DianeBossAnimatedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CraftNoTaizaiModEntities.DIANE_BOSS_ANIMATED.get(), world);
	}

	public DianeBossAnimatedEntity(EntityType<DianeBossAnimatedEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		DianeSpawnBossProcedure.execute(world, this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		DianeBossOnEntityTickUpdateProcedure.execute(this);
	...
	public static void init() {
		SpawnPlacements.register(CraftNoTaizaiModEntities.DIANE_BOSS_ANIMATED.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(DianeBossAnimatedEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
