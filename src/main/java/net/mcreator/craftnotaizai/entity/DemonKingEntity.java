...
import net.mcreator.craftnotaizai.procedures.DemonKingRightClickedOnEntityProcedure;
import net.mcreator.craftnotaizai.init.CraftNoTaizaiModEntities;

public class DemonKingEntity extends PathfinderMob {
	public DemonKingEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CraftNoTaizaiModEntities.DEMON_KING.get(), world);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		DemonKingRightClickedOnEntityProcedure.execute(world, x, y, z, sourceentity);
		return retval;
	}
