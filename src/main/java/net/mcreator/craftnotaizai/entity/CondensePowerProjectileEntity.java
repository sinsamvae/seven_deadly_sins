...
import net.mcreator.craftnotaizai.procedures.CondensePowerProjectileProjectileHitsLivingEntityProcedure;
...
public class CondensePowerProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		CondensePowerProjectileProjectileHitsLivingEntityProcedure.execute(this.level(), entityHitResult.getEntity(), this);
	}
