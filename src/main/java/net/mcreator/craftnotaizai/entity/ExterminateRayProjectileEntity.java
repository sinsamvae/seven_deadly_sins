...
import net.mcreator.craftnotaizai.procedures.ExterminateRayProjectileProjectileHitsLivingEntityProcedure;
...
public class ExterminateRayProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		ExterminateRayProjectileProjectileHitsLivingEntityProcedure.execute(this.level(), entityHitResult.getEntity(), this);
	}
