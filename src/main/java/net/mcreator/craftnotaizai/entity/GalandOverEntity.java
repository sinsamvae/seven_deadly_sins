...
import net.mcreator.craftnotaizai.procedures.GalandOverOnEntityTickUpdateProcedure;
...
public class GalandOverEntity extends PathfinderMob implements GeoEntity {
	...
	public GalandOverEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CraftNoTaizaiModEntities.GALAND_OVER.get(), world);
	}

	public GalandOverEntity(EntityType<GalandOverEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "galand_over");
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		GalandOverEntityDiesProcedure.execute(this.level(), this);
	}
	...
	public void baseTick() {
		super.baseTick();
		GalandOverOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(GalandOverEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
