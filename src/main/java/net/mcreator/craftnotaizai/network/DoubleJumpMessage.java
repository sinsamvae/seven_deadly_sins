...
import net.mcreator.craftnotaizai.procedures.DoubleJumpOnKeyPressedProcedure;
...
public class DoubleJumpMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CraftNoTaizaiMod.addNetworkMessage(DoubleJumpMessage.class, DoubleJumpMessage::buffer, DoubleJumpMessage::new, DoubleJumpMessage::handler);
	}
}
