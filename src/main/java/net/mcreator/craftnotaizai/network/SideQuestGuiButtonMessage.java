...
import net.mcreator.craftnotaizai.procedures.SideQuestClaimProcedure;
...
public class SideQuestGuiButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			SideQuestClaimProcedure.execute(world, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		CraftNoTaizaiMod.addNetworkMessage(SideQuestGuiButtonMessage.class, SideQuestGuiButtonMessage::buffer, SideQuestGuiButtonMessage::new, SideQuestGuiButtonMessage::handler);
	}
}
