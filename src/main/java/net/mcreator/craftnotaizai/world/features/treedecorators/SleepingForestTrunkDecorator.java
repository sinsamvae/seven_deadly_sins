...
public class SleepingForestTrunkDecorator extends TrunkVineDecorator {
	public static Codec<SleepingForestTrunkDecorator> CODEC = Codec.unit(SleepingForestTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("sleeping_forest_tree_trunk_decorator", DECORATOR_TYPE));
	}
