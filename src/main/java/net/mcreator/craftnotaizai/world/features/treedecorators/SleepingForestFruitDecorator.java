...
public class SleepingForestFruitDecorator extends CocoaDecorator {
	public static Codec<SleepingForestFruitDecorator> CODEC = Codec.unit(SleepingForestFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("sleeping_forest_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public SleepingForestFruitDecorator() {
		super(0.2f);
	}
