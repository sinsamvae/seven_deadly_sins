...
public class KegGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public KegGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(CraftNoTaizaiModMenus.KEG_GUI.get(), id);
		...
		this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 137, 40) {
			...
			@Override
			public boolean mayPlace(ItemStack stack) {
				return Items.HONEY_BOTTLE == stack.getItem();
			}
		}));
