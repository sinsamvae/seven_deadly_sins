...
public class CloverTradingMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CloverTradingMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(CraftNoTaizaiModMenus.CLOVER_TRADING.get(), id);
