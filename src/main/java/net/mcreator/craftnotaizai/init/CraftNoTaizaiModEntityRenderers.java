...
import net.mcreator.craftnotaizai.client.renderer.StoneDroleRenderer;
...
import net.mcreator.craftnotaizai.client.renderer.MossDragonRenderer;
...
import net.mcreator.craftnotaizai.client.renderer.IncreaseTrueSpiritSpearProjectileRenderer;
...
import net.mcreator.craftnotaizai.client.renderer.GowtherEP18Renderer;
...
import net.mcreator.craftnotaizai.client.renderer.GloxiniaStoryRenderer;
import net.mcreator.craftnotaizai.client.renderer.GloxinaBossRenderer;
...
import net.mcreator.craftnotaizai.client.renderer.GerheadeservantRenderer;
...
import net.mcreator.craftnotaizai.client.renderer.ElaineStoryRenderer;
...
import net.mcreator.craftnotaizai.client.renderer.DroleRenderer;
...
import net.mcreator.craftnotaizai.client.renderer.BreakableBugProjectileRenderer;
...
public class CraftNoTaizaiModEntityRenderers {
	...
	public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(CraftNoTaizaiModEntities.JIGUMO.get(), JigumoRenderer::new);
		event.registerEntityRenderer(CraftNoTaizaiModEntities.TORAH.get(), TorahRenderer::new);
		event.registerEntityRenderer(CraftNoTaizaiModEntities.GERHEADESERVANT.get(), GerheadeservantRenderer::new);
		event.registerEntityRenderer(CraftNoTaizaiModEntities.STONE_DROLE.get(), StoneDroleRenderer::new);
		event.registerEntityRenderer(CraftNoTaizaiModEntities.GOWTHER_EP_18.get(), GowtherEP18Renderer::new);
		event.registerEntityRenderer(CraftNoTaizaiModEntities.GLOXINIA_STORY.get(), GloxiniaStoryRenderer::new);
		event.registerEntityRenderer(CraftNoTaizaiModEntities.DROLE.get(), DroleRenderer::new);
		event.registerEntityRenderer(CraftNoTaizaiModEntities.INCREASE_TRUE_SPIRIT_SPEAR_PROJECTILE.get(), IncreaseTrueSpiritSpearProjectileRenderer::new);
		event.registerEntityRenderer(CraftNoTaizaiModEntities.BREAKABLE_BUG_PROJECTILE.get(), BreakableBugProjectileRenderer::new);
	}
}
